...
function [means, covariances, priors] = fisher_build_vocabulary( image_paths, num_clusters )
...
% Random Sampling
Y = randsample(size(all_sift_feat,2),rand_num);
rand_sift_feat = all_sift_feat(:,Y);

[means, covariances, priors] = vl_gmm(double(rand_sift_feat), num_clusters);
